...
class CompanyDataProvider {
 ...
 final response = await http.post(
  ...
  Future<void> deleteApps(String companyname) async {
   await http.delete(
                                Uri.parse('http://127.0.0.1:3000/delete/application/$companyname'),
                                headers: <String, String>{
                                  'Content-Type':
                                      'application/json; charset=UTF-8',
  ...
  Future<void> deletepostes(String companyname) async {
   await http.delete(
        Uri.parse('http://127.0.0.1:3000/delete/posts/$companyname'),
        headers: <String, String>{
          'Content-Type':
              'application/json; charset=UTF-8',
